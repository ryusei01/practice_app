...
const TOKUSHO_ITEMS: SectionItem[] = [
  {
    label: '販売業者',
    value: '[事業者名をここに記載してください]',
  },
  {
    label: '運営責任者',
    value: '[運営責任者氏名をここに記載してください]',
  },
  {
    label: '所在地',
    value: '[住所をここに記載してください]',
  },
  {
    label: '電話番号',
    value: '[電話番号をここに記載してください]\n（お問い合わせはメールにて承ります）',
  },
  {
    label: 'メールアドレス',
    value: '[メールアドレスをここに記載してください]',
  },
  {
    label: 'サービス名',
      ...
      <View style={styles.content}>
        ...
        <View style={styles.notice}>
          ...
          <Text style={styles.noticeText}>
            ...
            各問題集の販売者は個人ユーザーであり、当プラットフォームは決済処理および場の提供を行います。
          </Text>
          <Text style={styles.noticeText}>
            問題集の内容に関するお問い合わせは、各問題集の販売者へ直接ご連絡ください。
