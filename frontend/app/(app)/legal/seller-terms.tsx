...
const SECTIONS: Section[] = [
  {
    title: '第1条（目的）',
    content:
      '本販売者利用規約（以下「本規約」）は、AI Practice Book（以下「本サービス」）において問題集を販売するユーザー（以下「販売者」）が守るべきルールを定めるものです。販売者として登録した時点で本規約に同意したものとみなします。',
  },
  {
    title: '第2条（売上分配・手数料）',
    content:
  ...
  },
  {
    title: '第9条（規約の変更）',
    content:
      'AI Practice Bookは、必要に応じて本規約を変更する場合があります。変更後も本サービスを利用し続けた場合、変更後の規約に同意したものとみなします。重要な変更の場合はアプリ内通知でお知らせします。',
  },
];
